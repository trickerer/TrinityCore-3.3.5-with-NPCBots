...
{
    // Call base class and get its return value
    bool result = BfCapturePoint::SetCapturePointData(go);

    // Here you cannot assign m_team because no team argument
    // If you want, set a default or leave it untouched
