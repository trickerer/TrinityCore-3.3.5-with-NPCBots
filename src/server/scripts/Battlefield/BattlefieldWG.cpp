...
bool BattlefieldWG::Update(uint32 diff)
{
    ...
    {
        // Get the team controlling the battlefield
        TeamId ownerTeam = this->GetTeamControl();  // Correct method for 3.3.5a
        
        std::string owner = (ownerTeam == TEAM_HORDE) ? "Horde" : "Alliance";
