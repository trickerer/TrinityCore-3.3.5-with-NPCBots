...
void WorldSession::HandlePlayerLogin(LoginQueryHolder const& holder)
{
    ...
    {
        pCurrChar->GetSession()->SendNotification("It seems you are not using our client or need to update! |cffFF4500If you have recently updated relog!|r See Breaking news or visit - |cff00FF00Thttps://mgawow.online/how-to-update-client/|r");
        ...
        ChatHandler(pCurrChar->GetSession()).PSendSysMessage("It seems you are not using our client or need to update! |cffFF4500If you have recently updated relog!|r See Breaking news or visit - |cff00FF00Thttps://mgawow.online/how-to-update-client/|r");
    }
}
