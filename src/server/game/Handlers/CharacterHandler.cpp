...
void WorldSession::HandlePlayerLogin(LoginQueryHolder const& holder)
{
    ...
    if (spellInfo)
    {
        ...
        ChatHandler(pCurrChar->GetSession()).PSendSysMessage("I Don't hvae the MGAWoW Client, MGAWoW custom content will not work for me! - Download out client here https://mgawow.online/downlaod/ - This is optional");
    }
